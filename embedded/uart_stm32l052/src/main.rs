...
type RxTarget = serial::Rx<serial::USART1>;
type RxChannel = dma::Channel3;
...
type TxTarget = serial::Tx<serial::USART1>;
type TxChannel = dma::Channel2;
...
fn main() -> ! {
    ...
    let mut rx_state = RxState::READY(rx, dma.channels.channel3);
    let mut tx_state = TxState::READY(tx, dma.channels.channel2);
